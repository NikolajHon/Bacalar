...
const FifthLesson = () => {
    ...
    const lessonId = 'control-equipment';
    ...
    return (
        <div className='main-second'>
            ...
            <div className="second-lessons-page">
                ...
                <FirstSubtopicFifth onComplete={() => handleCompleteSubtopic(2)}
                                    completed={completedSubtopics.includes(2)}/>
                <SecondSubtopicFifth onComplete={() => handleCompleteSubtopic(3)}
                                     completed={completedSubtopics.includes(3)}/>
                <ThirdSubtopicFifth onComplete={() => handleCompleteSubtopic(4)}
