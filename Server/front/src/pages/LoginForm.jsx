...
const Form = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const {username, userId, rating = 0, role, photoUrl} = response.data;
            setUser({id: userId, name: username, rating, role, photoUrl});
      	...
      	C318.115,0,375.068,22.126,419.404,58.936z"/>
                    ...
                    <button className="btn apple">
                        <svg version="1.1" height={20} width={20} id="Capa_1" xmlns="http://www.w3.org/2000/svg"
                             xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 22.773 22.773"
                             style={{enableBackground: 'new 0 0 22.773 22.773'}} xmlSpace="preserve">
                            <g>
                                <g>
                                    <path
