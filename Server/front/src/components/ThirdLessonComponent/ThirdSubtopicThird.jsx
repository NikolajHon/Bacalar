...
const ThirdSubtopicThird = ({ onComplete, completed }) => {
    return (
        ...
        $
            ...
            <p style={{ textDecoration: 'underline' }}>Pre odstránenie adresára príkazom <code>rmdir</code> musia byť splnené nasledujúce podmienky:</p>
            <ol>
                <li class="custom-list">Adresár musí byť prázdny</li>
                <li class="custom-list">Používateľská identifikácia musí mať oprávnenie pre zápis a pre spustenie v rodičovskom adresári</li>
