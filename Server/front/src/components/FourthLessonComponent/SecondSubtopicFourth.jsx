                    ...
                    <tr>
                        ...
                        <td>
                            saved-text (sticky bit)
                                <strong>POZOR!</strong> Pri nastavovaní <code>S_SVTX</code> (sticky bitu) musíte mať privilégiá super-používateľa
                        </td>
                    </tr>
                    <tr>
                        <td>S_IRWXU <br />
                        ...
                        Vykonávanie pre používateľa (vlastníka)</td>
                    </tr>
