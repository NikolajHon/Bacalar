...
const LessonOverviewFourth = ({onComplete, completed}) => {
    return (
...
`
            ...
            <dl>
                ...
                <dd>pracovná skupina, do ktorej vlastník súboru patrí (pracovná skupina je každému používateľovi
                    pridelená správcom systému)
                </dd>
