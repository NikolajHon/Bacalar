...
const LessonOverview = ({onComplete, completed}) => {
    return (
        <div className="lesson-overview" id="section-0">
                            ...
                            <td>
                                <ul>
                                    <li>zmeniť základné nastavenie terminálu,
                                        napr. na vypnutie echa
                                    </li>
                                    <li>využiť zmenu nastavenia terminálu
                                        v zadaniach a ďalších programoch
                                    </li>
                                </ul>
                            </td>
                        </tr>
            ...
            <ul class="list-point">
                <li>
                    Znakové zariadenie reprezentujú technické zariadenia, ktoré zapisuje dáta ako postupnosť bajtov.
                    Patria sem porty, terminály alebo zvukové karty.
                </li>
                <li>
                    Blokové zariadenia reprezentujú zariadenia, ktoré čítajú alebo zapisujú dáta v blokoch stanovenej
                    veľkosti. Umožňujú priamy prístup k dátam uložených na zariadení. Patria sem napr. diskové
                    zariadenia.
                </li>
            </ul>
            <br/><br/>
            ...
            súborom. Tieto súbory sa spravidla nachádzajú v adresári <code>/dev</code>, napr.
            súbor <code>/dev/tty</code>
