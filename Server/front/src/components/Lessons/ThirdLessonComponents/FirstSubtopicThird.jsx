...
const FirstSubtopic = ({ onComplete, completed }) => {
    ...
    ls [-volba..] [meno_suboru...]
            ...
            <table>
                ...
                <tr>
                    <td>-I vzorka</td>
                    <td>nevypisujú sa súbory ktoré vyhovujú zadanej vzorke. Vzorku zadávame pomocou znakov '*' '?' napr.
                        *.tar spôsobí že sa nebudú vypisovať súbory s koncovkou tar
                    </td>
                </tr>
                <tr>
                    <td>-l (long)</td>
